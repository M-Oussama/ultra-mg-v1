...
<head>
    ...
    <style>
        ...
        .footer { width: 100%; text-align: center; font-size: 9px; border-top: 1px solid #000; padding-top: 10px; margin-top: 50px; }
    ...
    @foreach($invoices as $invoice)
        <div class="header">
            ...
            <div class="invoice-title">
                <h2 style="margin: 0;">FACTURE PROFORMA</h2>
        ...
        <table>
            ...
            <tbody>
                @foreach($invoice->certifyInvoiceProducts as $item)
                <tr>
        ...
        <div class="totals-container">
            <div class="totals-left">
                ...
                <strong>{{ $invoice->amountLetter }}</strong>
