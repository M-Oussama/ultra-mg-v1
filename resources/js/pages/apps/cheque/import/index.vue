...
import { useChequeImportStore } from '@/views/apps/cheque/useChequeImportStore'

const store = useChequeImportStore()
  ...
  <section>
    <VRow>
      <VCol cols="12" md="9" lg="8">
        <VCard title="Import Cheques CSV">
          <VCardText class="pt-4">
            <p class="mb-4 text-body-2">
              Required columns: <strong>id</strong>, <strong>date</strong>, <strong>number</strong>, <strong>amount</strong>, <strong>bank</strong>, <strong>pdf_url</strong>, <strong>pdf_name</strong>, <strong>client_id</strong>, <strong>company_id</strong>, <strong>notes</strong>.
            </p>
