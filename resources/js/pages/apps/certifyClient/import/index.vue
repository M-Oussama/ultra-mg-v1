...
import { useCertifyClientStore } from '@/views/apps/certifyClient/useCertifyClientStore'

const certifyClientStore = useCertifyClientStore()
...
const handleImport = async () => {
  ...
  try {
    const response = await certifyClientStore.importCsv(selectedFile.value)
  ...
  <section>
    <VRow>
      <VCol cols="12" md="8" lg="7">
        <VCard title="Import Certify Clients CSV">
          <VCardText class="pt-4">
            <p class="mb-4 text-body-2">
              Required column: <strong>name</strong>. Include either <strong>city_id</strong> or <strong>city</strong>.
            </p>
