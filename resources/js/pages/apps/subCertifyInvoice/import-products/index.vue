...
import { useSubCertifyInvoiceProductsImportStore } from '@/views/apps/subCertifyInvoice/useSubCertifyInvoiceProductsImportStore'

const store = useSubCertifyInvoiceProductsImportStore()
  ...
  <section>
    <VRow>
      <VCol
        ...
        lg="7"
      >
        <VCard title="Import Sub Certify Invoice Products CSV">
          <VCardText class="pt-4">
            ...
            <p class="mb-4 text-body-2">
              The <strong>command_id</strong> column maps to the parent <strong>sub_certify_invoice_id</strong>.
            </p>
