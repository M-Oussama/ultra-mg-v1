...
import { useCertifyProductStore } from '@/views/apps/certifyProduct/useCertifyProductStore'

const certifyProductStore = useCertifyProductStore()
...
const handleImport = async () => {
  ...
  try {
    const response = await certifyProductStore.importCsv(selectedFile.value)
  ...
  <section>
    <VRow>
      <VCol cols="12" md="8" lg="7">
        <VCard title="Import Certify Products CSV">
          <VCardText class="pt-4">
            <p class="mb-4 text-body-2">
              Required columns: <strong>name</strong>, <strong>price</strong>. <strong>tax_rate</strong> is optional and defaults to <strong>0</strong>.
            </p>
