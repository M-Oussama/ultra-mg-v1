...
const handleImport = async () => {
  ...
  try {
    const response = await store.importReturnListsCsv(selectedFile.value)
  ...
  <section>
    <VRow>
      <VCol cols="12" md="9" lg="8">
        <VCard title="Import Product Return Lists CSV">
          <VCardText class="pt-4">
            <p class="mb-4 text-body-2">
              Required columns: <strong>id</strong>, <strong>return_id</strong>, <strong>client_id</strong>, <strong>product_id</strong>, <strong>quantity</strong>, <strong>price</strong>, <strong>total_price</strong>, <strong>date</strong>.
            </p>
