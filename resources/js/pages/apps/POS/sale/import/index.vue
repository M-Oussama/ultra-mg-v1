...
import { useSalesImportStore } from '@/views/apps/POS/sales/useSalesImportStore'

const store = useSalesImportStore()
        ...
        <VCard title="Import Sales CSV">
          <VCardText class="pt-4">
            ...
            <p class="mb-4 text-body-2">
              Required CSV columns: <strong>id</strong>, <strong>sale_date</strong>, <strong>client_id</strong>, <strong>total_amount</strong>, <strong>sale_statuses_id</strong>, <strong>regulation</strong>, <strong>payment</strong>, <strong>balance</strong>.
            </p>
