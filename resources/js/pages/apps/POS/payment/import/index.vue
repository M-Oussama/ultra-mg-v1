...
const handleImport = async () => {
  ...
  try {
    const response = await store.importPaymentsCsv(selectedFile.value, departmentId.value)
  ...
  <section>
    <VRow>
      <VCol cols="12" md="9" lg="8">
        <VCard title="Import Payments CSV">
          <VCardText class="pt-4">
            ...
            <p class="mb-4 text-body-2">
              Required columns: <strong>id</strong>, <strong>sale_id</strong>, <strong>client_id</strong>, <strong>amount_paid</strong>, <strong>payment_date</strong>, <strong>note</strong>, <strong>active</strong>.
            </p>
