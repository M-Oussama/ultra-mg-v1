          ...
          <VTable class="text-no-wrap">
            ...
            <tbody>
              ...
              >
                ...
                <td>
                  <span class="text-capitalize text-base font-weight-semibold">{{ parseFloat(benefit.total_amount).toFixed(2) }} </span>
                </td>
                <td>
                  <span class="text-capitalize text-base font-weight-semibold">{{ benefit.totalPayments ? parseFloat(benefit.totalPayments).toFixed(2) : 0.00 }} DZD</span>
                </td>
                ...
                >
                  ...
                  <VBtn
                    ...
                    color="default"
                    variant="text"
                    :to="{ name: 'apps-POS-benefitUltra-edit-id', params: { id: benefit.id } }"
